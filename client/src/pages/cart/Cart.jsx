...
function Cart() {
  const { cart, cartDeleteOne, cartClearAll, updateCartQuantity } = useContext(CartContext);
    ...
    return (
      <div className="container mx-auto p-8">
        <div className="flex flex-col items-center justify-center text-center py-24">
          ...
          <p className="text-gray-500 mb-6">Browse through products and add them to your cart!</p>
      ...
      <div className="bg-white rounded-lg shadow-xl">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-3/4 p-6 space-y-6">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Your Shopping Cart</h2>
            {cart.items.map((item) => (
              <div
                key={item._id}
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">{formatPrice(item.productId.price)}</p>
